                ...
                <Navbar dark expand="md">
                    <div className="container">
                        ...
                        <Nav navbar>
                            ...
                            <NavItem>
                            <NavLink className="nav-link" to='/home'><span className="fa fa-list fa-lg"></span> Menu</NavLink>
                            </NavItem>
                            <NavItem>
                            <NavLink className="nav-link" to='/home'><span className="fa fa-address-card fa-lg"></span> Home</NavLink>
                            </NavItem>
                        </Nav>
                        </Collapse>
                    </div>
